...
public class technology_f extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_technology_f, container, false);
        recyclerView = view.findViewById(R.id.technology_recycler);
        model = new ArrayList<>();
    ...
    private void getnews() {
        ApiUtilities.getapiInterface().getNews("us", "technology", api_key)
