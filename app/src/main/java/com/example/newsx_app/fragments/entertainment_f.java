...
public class entertainment_f extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_entertainment_f, container, false);
        recyclerView = view.findViewById(R.id.entertainment_recycler) ;
        model = new ArrayList<>() ;
    ...
    private void getnews() {
        ApiUtilities.getapiInterface().getNews("us", "entertainment", api_key)
