...
public class health_f extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_health_f, container, false);
    ...
    private void getnews() {
        ApiUtilities.getapiInterface().getNews("us", "health", api_key)
