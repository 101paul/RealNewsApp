...
public class business_f extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_business_f, container, false);
    ...
    void getnews(){
        ApiUtilities.getapiInterface().getNews("us","business",api_key)
